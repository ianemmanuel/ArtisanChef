...
import { formatMockCurrency } from "@/lib/mock/vendor-revenue"
...
/**
 * Ranked leaderboard for /vendors/revenue — same visual shape as
 ...
 * their detail page) and non-linkable ones (outlets — no admin detail page
 * exists yet, see CLAUDE.md's outlet-administration gap).
 */
export function VendorRevenueLeaderboard({ title, description, icon: Icon, badgeClass, entries, emptyTitle, emptyDescription }: Props) {
  return (
