...
export default async function UserReviewPage({ params }: Props) {
  ...
  if (!session.permissions.includes(AdminPermissions.ADMIN_USERS_PROFILES_READ)) redirect("/identity/manage")
  ...
  return (
    <div className="page-content animate-slide-up">
      ...
      <Button asChild variant="ghost" size="sm" className="-ml-1">
        <Link href="/identity/manage"><ArrowLeft className="mr-1.5 h-4 w-4" />Back to Users</Link>
      </Button>
